# memo-activity-history Specification

## Purpose
Provides an audit log and activity history timeline for memo cards on boards, tracking metadata mutations such as category modifications, milestone changes, column moves, status transitions, and deadline adjustments.
