...
type Memo struct {
	...
	// Optional. The kanban card state of the memo.
	// Settable via UpdateMemo with the "kanban" field mask path.
	// An empty kanban message clears the card state.
	Kanban *Kanban `protobuf:"bytes,19,opt,name=kanban,proto3,oneof" json:"kanban,omitempty"`
	// Output only. The activity history of the memo on boards.
...
func (x *Memo) GetActivities() []*Activity {
	if x != nil {
		return x.Activities
	}
	return nil
...
// Activity is an audit log of changes made to a memo's metadata on boards.
type Activity struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The resource name of the activity.
	// Format: memos/{memo}/activities/{activity}
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// The type of activity (e.g. "UPDATE_CATEGORY", "UPDATE_MILESTONE", "MOVE_COLUMN", "UPDATE_STATUS", "UPDATE_DUE_TIME").
	Type string `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`
	// Human readable description of what changed.
	Description string `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	// Output only. The creation timestamp of this activity log.
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// The resource name of the user who performed the activity.
	// Format: users/{user}
...
func (x *Activity) GetOldValue() string {
...
func (x *Activity) GetNewValue() string {
...
type Kanban struct {
	...
	// Optional target due time for this card.
	...
	// Optional milestone badge color hex.
...
func (x *Kanban) GetBoardId() string {
	if x != nil {
		return x.BoardId
	}
	return ""
...
func (x *Kanban) GetColumnId() string {
	if x != nil {
		return x.ColumnId
	}
	return ""
...
func (x *Kanban) GetPosition() float64 {
	if x != nil {
		return x.Position
	}
	return 0
...
func (x *Kanban) GetCategory() string {
...
func (x *Kanban) GetCategoryColorHex() string {
...
func (x *Kanban) GetDueTime() *timestamppb.Timestamp {
	if x != nil {
		return x.DueTime
	}
	return nil
...
func (x *Kanban) GetIsClosed() bool {
...
func (x *Kanban) GetCategories() []string {
	if x != nil {
		return x.Categories
	}
	return nil
...
func (x *Kanban) GetMilestoneColorHex() string {
...
type ListMemosRequest struct {
	...
	//	kanban_board / kanban_column (string), kanban_position (double),
	//	has_kanban (bool; true when the memo is on a board).
	//
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"\blocation\x18\x12 \x01(\v2\x16.memos.api.v1.LocationB\x03\xe0A\x01H\x01R\blocation\x88\x01\x01\x126\n" +
	"\x06kanban\x18\x13 \x01(\v2\x14.memos.api.v1.KanbanB\x03\xe0A\x01H\x02R\x06kanban\x88\x01\x01\x12;\n" +
	"\n" +
	"activities\x18\x14 \x03(\v2\x16.memos.api.v1.ActivityB\x03\xe0A\x03R\n" +
	...
	"\a_parentB\v\n" +
	"\t_locationB\t\n" +
	"\a_kanbanJ\x04\b\x06\x10\aR\fdisplay_time\"\xa3\x03\n" +
	"\bActivity\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\x03\xe0A\bR\x04name\x12\x17\n" +
	...
	"\x11memos.api.v1/UserR\acreator\x12%\n" +
	"\told_value\x18\x06 \x01(\tB\x03\xe0A\x03H\x00R\boldValue\x88\x01\x01\x12%\n" +
	"\tnew_value\x18\a \x01(\tB\x03\xe0A\x03H\x01R\bnewValue\x88\x01\x01:Z\xeaAW\n" +
	"\x15memos.api.v1/Activity\x12\"memos/{memo}/activities/{activity}\x1a\x04name*\n" +
	"activities2\bactivityB\f\n" +
	"\n" +
	"_old_valueB\f\n" +
	"\n" +
	"_new_value\"\x9d\x04\n" +
	...
	"\bposition\x18\x03 \x01(\x01B\x03\xe0A\x01R\bposition\x12$\n" +
	"\bcategory\x18\x04 \x01(\tB\x03\xe0A\x01H\x00R\bcategory\x88\x01\x01\x126\n" +
	"\x12category_color_hex\x18\x05 \x01(\tB\x03\xe0A\x01H\x01R\x10categoryColorHex\x88\x01\x01\x12?\n" +
	"\bdue_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01H\x02R\adueTime\x88\x01\x01\x12%\n" +
	"\tis_closed\x18\a \x01(\bB\x03\xe0A\x01H\x03R\bisClosed\x88\x01\x01\x12#\n" +
	"\n" +
	"categories\x18\b \x03(\tB\x03\xe0A\x01R\n" +
	"categories\x12&\n" +
	"\tmilestone\x18\t \x01(\tB\x03\xe0A\x01H\x04R\tmilestone\x88\x01\x01\x128\n" +
	"\x13milestone_color_hex\x18\n" +
	" \x01(\tB\x03\xe0A\x01H\x05R\x11milestoneColorHex\x88\x01\x01B\v\n" +
	"\t_categoryB\x15\n" +
...
var file_api_v1_memo_service_proto_goTypes = []any{
	...
	(*Activity)(nil),                     // 4: memos.api.v1.Activity
	(*Kanban)(nil),                       // 5: memos.api.v1.Kanban
	(*Location)(nil),                     // 6: memos.api.v1.Location
	(*CreateMemoRequest)(nil),            // 7: memos.api.v1.CreateMemoRequest
	(*ListMemosRequest)(nil),             // 8: memos.api.v1.ListMemosRequest
	(*ListMemosResponse)(nil),            // 9: memos.api.v1.ListMemosResponse
...
var file_api_v1_memo_service_proto_depIdxs = []int32{
	...
	6,  // 9: memos.api.v1.Memo.location:type_name -> memos.api.v1.Location
	5,  // 10: memos.api.v1.Memo.kanban:type_name -> memos.api.v1.Kanban
	4,  // 11: memos.api.v1.Memo.activities:type_name -> memos.api.v1.Activity
	39, // 12: memos.api.v1.Activity.create_time:type_name -> google.protobuf.Timestamp
	39, // 13: memos.api.v1.Kanban.due_time:type_name -> google.protobuf.Timestamp
	3,  // 14: memos.api.v1.CreateMemoRequest.memo:type_name -> memos.api.v1.Memo
	40, // 15: memos.api.v1.ListMemosRequest.state:type_name -> memos.api.v1.State
	3,  // 16: memos.api.v1.ListMemosResponse.memos:type_name -> memos.api.v1.Memo
	3,  // 17: memos.api.v1.UpdateMemoRequest.memo:type_name -> memos.api.v1.Memo
	42, // 18: memos.api.v1.UpdateMemoRequest.update_mask:type_name -> google.protobuf.FieldMask
	41, // 19: memos.api.v1.SetMemoAttachmentsRequest.attachments:type_name -> memos.api.v1.Attachment
	41, // 20: memos.api.v1.ListMemoAttachmentsResponse.attachments:type_name -> memos.api.v1.Attachment
	38, // 21: memos.api.v1.MemoRelation.memo:type_name -> memos.api.v1.MemoRelation.Memo
	38, // 22: memos.api.v1.MemoRelation.related_memo:type_name -> memos.api.v1.MemoRelation.Memo
	1,  // 23: memos.api.v1.MemoRelation.type:type_name -> memos.api.v1.MemoRelation.Type
	16, // 24: memos.api.v1.SetMemoRelationsRequest.relations:type_name -> memos.api.v1.MemoRelation
	16, // 25: memos.api.v1.ListMemoRelationsResponse.relations:type_name -> memos.api.v1.MemoRelation
	3,  // 26: memos.api.v1.CreateMemoCommentRequest.comment:type_name -> memos.api.v1.Memo
	3,  // 27: memos.api.v1.ListMemoCommentsResponse.memos:type_name -> memos.api.v1.Memo
	2,  // 28: memos.api.v1.ListMemoReactionsResponse.reactions:type_name -> memos.api.v1.Reaction
	2,  // 29: memos.api.v1.UpsertMemoReactionRequest.reaction:type_name -> memos.api.v1.Reaction
	39, // 30: memos.api.v1.MemoShare.create_time:type_name -> google.protobuf.Timestamp
	39, // 31: memos.api.v1.MemoShare.expire_time:type_name -> google.protobuf.Timestamp
	27, // 32: memos.api.v1.CreateMemoShareRequest.memo_share:type_name -> memos.api.v1.MemoShare
	27, // 33: memos.api.v1.ListMemoSharesResponse.memo_shares:type_name -> memos.api.v1.MemoShare
	36, // 34: memos.api.v1.BatchGetLinkMetadataResponse.link_metadata:type_name -> memos.api.v1.LinkMetadata
	7,  // 35: memos.api.v1.MemoService.CreateMemo:input_type -> memos.api.v1.CreateMemoRequest
	8,  // 36: memos.api.v1.MemoService.ListMemos:input_type -> memos.api.v1.ListMemosRequest
	10, // 37: memos.api.v1.MemoService.GetMemo:input_type -> memos.api.v1.GetMemoRequest
	11, // 38: memos.api.v1.MemoService.UpdateMemo:input_type -> memos.api.v1.UpdateMemoRequest
	12, // 39: memos.api.v1.MemoService.DeleteMemo:input_type -> memos.api.v1.DeleteMemoRequest
	13, // 40: memos.api.v1.MemoService.SetMemoAttachments:input_type -> memos.api.v1.SetMemoAttachmentsRequest
	14, // 41: memos.api.v1.MemoService.ListMemoAttachments:input_type -> memos.api.v1.ListMemoAttachmentsRequest
	17, // 42: memos.api.v1.MemoService.SetMemoRelations:input_type -> memos.api.v1.SetMemoRelationsRequest
	18, // 43: memos.api.v1.MemoService.ListMemoRelations:input_type -> memos.api.v1.ListMemoRelationsRequest
	20, // 44: memos.api.v1.MemoService.CreateMemoComment:input_type -> memos.api.v1.CreateMemoCommentRequest
	21, // 45: memos.api.v1.MemoService.ListMemoComments:input_type -> memos.api.v1.ListMemoCommentsRequest
	23, // 46: memos.api.v1.MemoService.ListMemoReactions:input_type -> memos.api.v1.ListMemoReactionsRequest
	25, // 47: memos.api.v1.MemoService.UpsertMemoReaction:input_type -> memos.api.v1.UpsertMemoReactionRequest
	26, // 48: memos.api.v1.MemoService.DeleteMemoReaction:input_type -> memos.api.v1.DeleteMemoReactionRequest
	28, // 49: memos.api.v1.MemoService.CreateMemoShare:input_type -> memos.api.v1.CreateMemoShareRequest
	29, // 50: memos.api.v1.MemoService.ListMemoShares:input_type -> memos.api.v1.ListMemoSharesRequest
	31, // 51: memos.api.v1.MemoService.DeleteMemoShare:input_type -> memos.api.v1.DeleteMemoShareRequest
	32, // 52: memos.api.v1.MemoService.GetSharedMemo:input_type -> memos.api.v1.GetSharedMemoRequest
	33, // 53: memos.api.v1.MemoService.GetLinkMetadata:input_type -> memos.api.v1.GetLinkMetadataRequest
	34, // 54: memos.api.v1.MemoService.BatchGetLinkMetadata:input_type -> memos.api.v1.BatchGetLinkMetadataRequest
	3,  // 55: memos.api.v1.MemoService.CreateMemo:output_type -> memos.api.v1.Memo
	9,  // 56: memos.api.v1.MemoService.ListMemos:output_type -> memos.api.v1.ListMemosResponse
