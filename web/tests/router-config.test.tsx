...
describe("router configuration", () => {
  ...
  it("wraps authenticated-only pages in RequireAuthRoute", () => {
    for (const path of [ROUTES.ARCHIVED, ROUTES.VIEWS, ROUTES.BOARDS, ROUTES.SNIPPETS, ROUTES.ATTACHMENTS, ROUTES.INBOX, ROUTES.SETTING]) {
  ...
  it("keeps non-feed pages behind their full initialization requirements", () => {
    for (const path of [ROUTES.VIEWS, ROUTES.BOARDS, ROUTES.SNIPPETS, ROUTES.ATTACHMENTS, ROUTES.INBOX, ROUTES.SETTING]) {
